...
const LandingPage = () => {
    ...
    return (
        ...
        <div className='no-scrollbar flex flex-col w-screen h-screen overflow-x-hidden bg-app-background-1 '>
                <nav className="border-b  h-20 flex justify-between items-center p-3 md:items-center ml-3 space-x-2 lg:space-x-3 xl:space-x-6 absolute md:static bg-transparent md:z-auto z-[-1] left-0 w-full md:w-auto md:pl-0 pl-9 transition-all duration-500 ease-in top-20">
                ...
                <section className=" w-full p-20 app-background-1 flex  items-center justify-center  h-[800px]">
                    <div className=" flex items-center h-full mb-10 justify-center ">
                        <div className='w-3/5  gap-5'>

                            <div className=" flex flex-col gap-5 min-w-min">
